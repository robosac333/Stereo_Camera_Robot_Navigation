...
#include <stddef.h>
#include "mage_msgs/msg/detail/marker_array__rosidl_typesupport_introspection_c.h"
...
// Member `markers`
#include "mage_msgs/msg/marker.h"
// Member `markers`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  mage_msgs__msg__MarkerArray__init(message_memory);
}

void MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_fini_function(void * message_memory)
{
  mage_msgs__msg__MarkerArray__fini(message_memory);
}

size_t MarkerArray__rosidl_typesupport_introspection_c__size_function__Marker__markers(
  const void * untyped_member)
{
  const mage_msgs__msg__Marker__Sequence * member =
    (const mage_msgs__msg__Marker__Sequence *)(untyped_member);
  return member->size;
}
...
{
  mage_msgs__msg__Marker__Sequence * member =
    (mage_msgs__msg__Marker__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  mage_msgs__msg__Marker__Sequence * member =
    (mage_msgs__msg__Marker__Sequence *)(untyped_member);
  mage_msgs__msg__Marker__Sequence__fini(member);
  return mage_msgs__msg__Marker__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(mage_msgs__msg__MarkerArray, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mage_msgs__msg__MarkerArray, markers),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_message_members = {
  ...
  2,  // number of fields
  sizeof(mage_msgs__msg__MarkerArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mage_msgs, msg, MarkerArray)() {
  MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_message_member_array[1].members_ =
