...
#include "mage_msgs/msg/detail/marker__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mage_msgs::msg::Marker & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mage_msgs::msg::Marker & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const mage_msgs::msg::Marker *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mage_msgs::msg::Marker *>(
    untyped_ros_message);
...
{
  return &mage_msgs::msg::typesupport_fastrtps_cpp::_Marker__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mage_msgs, msg, Marker)() {
  return &mage_msgs::msg::typesupport_fastrtps_cpp::_Marker__handle;
}
