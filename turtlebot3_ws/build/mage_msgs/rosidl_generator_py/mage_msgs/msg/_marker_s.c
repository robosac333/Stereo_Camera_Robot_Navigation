...
bool mage_msgs__msg__marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mage_msgs.msg._marker.Marker", full_classname_dest, 28) == 0);
  }
  mage_msgs__msg__Marker * ros_message = _ros_message;
  {  // header
...
PyObject * mage_msgs__msg__marker__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mage_msgs.msg._marker");
