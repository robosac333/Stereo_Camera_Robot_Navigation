...
#include "mage_msgs/msg/detail/marker_array__rosidl_typesupport_fastrtps_c.h"
...
#include "mage_msgs/msg/detail/marker__functions.h"  // markers
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_mage_msgs__msg__Marker(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_mage_msgs__msg__Marker(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mage_msgs, msg, Marker)();
...
using _MarkerArray__ros_msg_type = mage_msgs__msg__MarkerArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: markers
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mage_msgs, msg, Marker
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: markers
  {
    ...
    if (ros_message->markers.data) {
      mage_msgs__msg__Marker__Sequence__fini(&ros_message->markers);
    }
    if (!mage_msgs__msg__Marker__Sequence__init(&ros_message->markers, size)) {
...
size_t get_serialized_size_mage_msgs__msg__MarkerArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MarkerArray__ros_msg_type * ros_message = static_cast<const _MarkerArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mage_msgs__msg__Marker(
...
static uint32_t _MarkerArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mage_msgs__msg__MarkerArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mage_msgs
size_t max_serialized_size_mage_msgs__msg__MarkerArray(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_mage_msgs__msg__Marker(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_mage_msgs__msg__MarkerArray(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mage_msgs, msg, MarkerArray)() {
