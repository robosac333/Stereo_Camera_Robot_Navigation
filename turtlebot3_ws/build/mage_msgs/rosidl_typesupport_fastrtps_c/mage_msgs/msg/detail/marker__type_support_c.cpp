...
#include "mage_msgs/msg/detail/marker__rosidl_typesupport_fastrtps_c.h"
...
using _Marker__ros_msg_type = mage_msgs__msg__Marker;
...
static uint32_t _Marker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mage_msgs__msg__Marker(
...
{
  return max_serialized_size_mage_msgs__msg__Marker(
    full_bounded, 0);
}
