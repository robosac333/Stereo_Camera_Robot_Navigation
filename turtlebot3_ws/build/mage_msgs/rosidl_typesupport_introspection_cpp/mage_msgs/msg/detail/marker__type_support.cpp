...
{
  new (message_memory) mage_msgs::msg::Marker(_init);
}

void Marker_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mage_msgs::msg::Marker *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Marker_message_member_array[4] = {
  {
    ...
    offsetof(mage_msgs::msg::Marker, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mage_msgs::msg::Marker, id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mage_msgs::msg::Marker, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mage_msgs::msg::Marker, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<mage_msgs::msg::Marker>()
{
  return &::mage_msgs::msg::rosidl_typesupport_introspection_cpp::Marker_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mage_msgs, msg, Marker)() {
  return &::mage_msgs::msg::rosidl_typesupport_introspection_cpp::Marker_message_type_support_handle;
}
