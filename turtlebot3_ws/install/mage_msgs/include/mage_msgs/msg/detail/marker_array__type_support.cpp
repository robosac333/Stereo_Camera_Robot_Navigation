...
{
  new (message_memory) mage_msgs::msg::MarkerArray(_init);
}

void MarkerArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mage_msgs::msg::MarkerArray *>(message_memory);
  typed_message->~MarkerArray();
}

size_t size_function__MarkerArray__markers(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<mage_msgs::msg::Marker> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<mage_msgs::msg::Marker> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<mage_msgs::msg::Marker> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MarkerArray_message_member_array[2] = {
  {
    ...
    offsetof(mage_msgs::msg::MarkerArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<mage_msgs::msg::Marker>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(mage_msgs::msg::MarkerArray, markers),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MarkerArray_message_members = {
  ...
  2,  // number of fields
  sizeof(mage_msgs::msg::MarkerArray),
...
{
  return &::mage_msgs::msg::rosidl_typesupport_introspection_cpp::MarkerArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mage_msgs, msg, MarkerArray)() {
  return &::mage_msgs::msg::rosidl_typesupport_introspection_cpp::MarkerArray_message_type_support_handle;
}
